...
There is a known issue, unrelated to the patch itself, where tiles would appear completely blank (white). To fix this, just switch to software renderer and then back to hardware renderer (press F9 twice).
